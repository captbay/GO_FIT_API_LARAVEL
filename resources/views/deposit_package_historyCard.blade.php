                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <address>
                                    ...
                                    {{ $deposit_package_history->no_deposit_package_history	 }}<br>
                                </address>
                                <address>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right">
                                <address>
                                    ...
                                    {{ $deposit_package_history->date_time }}
                                </address>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr class="line">
                                            ...
                                            <td class="text-right"><strong>KELAS</strong></td>
                                            <td class="text-right"><strong>TOTAL DEPOSIT PACKAGE</strong></td>
                                            <td class="text-right"><strong>EXPIRED</strong></td>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right">{{$deposit_package_history->package_amount}}</td>
                                            <td class="text-right">{{$deposit_package_history->expired_date}}</td>
                                            <td class="text-right">@currency($deposit_package_history->total_price)</td>
                                            @else
                                            <td class="text-center">@currency($class_detail->price) X {{$deposit_package_history->package_amount}} <br> @currency($deposit_package_history->total_price) </td>
                                            <td class="text-center">{{$class_detail->name}}</td>
                                            <td class="text-right">{{$deposit_package_history->package_amount}}</td>
                                            <td class="text-right">{{$deposit_package_history->expired_date}}</td>
                                            <td class="text-right">@currency($deposit_package_history->total_price)</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><strong>@currency($deposit_package_history->total_price)</strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
