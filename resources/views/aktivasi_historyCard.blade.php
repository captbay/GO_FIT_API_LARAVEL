                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr class="line">
                                            ...
                                            <td class="text-center"><strong>PAX</strong></td>
                                            <td class="text-center"><strong>EXTENDED DATE</strong></td>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td><strong>Aktivasi Tahunan</strong><br>aktivasi tahunan member gym yang
                                                akan mengaktifkan/menambahkan masa berlaku member gym dengan fasilitas
                                                yang mumpuni.</td>
                                            <td class="text-center">1</td>
                                            <td class="text-center">{{ $member->expired_date_membership }}</td>
                                            <td class="text-center">@currency($aktivasi_history->price)</td>
